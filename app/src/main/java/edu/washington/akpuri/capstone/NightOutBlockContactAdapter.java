 ...
 */
public class NightOutBlockContactAdapter extends ArrayAdapter<Contact> {
    private final ArrayList<Contact> contactList;
    private final Context context;
    private final ArrayList<Contact> blockedContacts;
    private final SingletonNightOutSettings instance;

    public NightOutBlockContactAdapter(Context context, int resource, ArrayList<Contact> allContacts, ArrayList<Contact> blockedContacts) {
